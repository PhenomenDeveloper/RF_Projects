...
@IBDesignable
// SCHOOL: IBDesignable не использовал в итоге?

// SCHOOL: я бы назвал BackgroundGradientView - последнее слово в названии класса должно давать представление о том, как этот класс использовать
